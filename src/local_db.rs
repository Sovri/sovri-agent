...
impl LocalDatabase {
    ...
    /// Writes the score summaries from a completed scan corpus into the local database.
    ///
    /// # Errors
    ///
    /// Returns an error if `SQLite` cannot persist the score summaries.
